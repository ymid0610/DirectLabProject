...
// Windows 헤더 파일
#include <windows.h>
#include <mmsystem.h> // timeGetTime() 함수 사용을 위해 추가
...
#pragma comment(lib, "winmm.lib") // mmsystem.h의 함수들을 링크하기 위해 추가
...
namespace Vector3
{
	...
	*/
	// 수정 후
	inline XMFLOAT3 TransformNormal(XMFLOAT3& xmf3Vector, const XMMATRIX& xmmtxTransform)
	{
		XMFLOAT3 xmf3Result;
		XMStoreFloat3(&xmf3Result, XMVector3TransformNormal(XMLoadFloat3(&xmf3Vector),
			xmmtxTransform));
